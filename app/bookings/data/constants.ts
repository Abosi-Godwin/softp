...
export const SERVICES: Record<ServiceKey, Service> = {
    acting: {
        ...
        fields: [
            ...
            {
                id: "role",
                label: "Role / Character Description",
                type: "textarea",
                placeholder:
                    "Briefly describe the character or role you have in mind…"
            },
            {
                id: "timeline",
    ...
    music: {
        ...
        fields: [
            ...
            {
                id: "reference",
                label: "Reference Track or Mood",
                type: "text",
                placeholder: "Drop a link or describe the sonic direction…"
            },
            {
                id: "deadline",
