...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-32 lg:py-52 bg-primary relative border-t border-white/5">
        ...
        <div className="grid lg:grid-cols-12 gap-16 lg:gap-24">
          ...
          >
            ...
            <div className="flex flex-col gap-2">
              ...
              <a href="mailto:jonathan@vancearts.com" className="text-xl font-heading text-letters-primary hover:text-gold transition-colors inline-block">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-xl font-heading text-letters-primary">The Vanguard Agency</p>
              <a href="mailto:contact@vanguard.com" className="text-letters-muted hover:text-gold transition-colors">
                contact@vanguard.com
              </a>
              <p className="text-letters-muted">+1 (555) 019-8273</p>
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-xl font-heading text-letters-primary">Los Angeles, CA</p>
              <p className="text-letters-muted">Available for global travel.</p>
            </div>
          </motion.div>
          ...
          >
            <form className="flex flex-col gap-6" onSubmit={(e) => e.preventDefault()}>
              ...
              <motion.div variants={inputVariants} className="flex flex-col gap-2">
                <label htmlFor="name" className="text-[10px] uppercase tracking-widest text-letters-muted pl-4">Name</label>
                <input 
                  type="text" 
                  id="name"
              ...
              <motion.div variants={inputVariants} className="flex flex-col gap-2">
                <label htmlFor="email" className="text-[10px] uppercase tracking-widest text-letters-muted pl-4">Email Address</label>
                <input 
                  type="email" 
                  id="email"
              ...
              <motion.div variants={inputVariants} className="flex flex-col gap-2">
                <label htmlFor="subject" className="text-[10px] uppercase tracking-widest text-letters-muted pl-4">Subject</label>
                <select 
                  id="subject"
                ...
                >
                  <option value="" disabled>Select inquiry type</option> {/* Removed 'selected' */}
                  <option value="booking">Project Booking</option>
              ...
              <motion.div variants={inputVariants} className="flex flex-col gap-2">
                <label htmlFor="message" className="text-[10px] uppercase tracking-widest text-letters-muted pl-4">Message</label>
                <textarea 
                  id="message"
                  rows={5}
