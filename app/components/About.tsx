...
export default function About() {
  ...
  return (
    <section id="about" className="relative py-32 lg:py-52 bg-primary overflow-hidden">
        ...
        <div className="flex flex-col items-start gap-8">
          ...
          >
            <p className="text-letters-muted text-lg lg:text-xl leading-relaxed font-body">
              Soft P is a multidisciplinary artist whose work explores the intersection of 
              human emotion and digital precision. From the stage to the recording studio, 
              every project is a search for authentic connection.
            </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mt-20 pt-12 border-t border-white/5 w-full">
            {[
              ...
              >
                <span className="text-letters-muted text-[9px] uppercase tracking-[0.3em] mb-1">{stat.label}</span>
                <span className="text-letters-primary font-heading text-2xl font-bold">{stat.val}</span>
              </motion.div>
            ))}
          </div>
