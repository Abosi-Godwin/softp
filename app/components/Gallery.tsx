...
const GALLERY_IMAGES = [
    ...
    {
        src: "FB_IMG_1773000974551_lhhtu0",
        size: "sm",
        title: "Animation Roughs"
    },
    { src: "FB_IMG_1773000981569_fgsust", size: "md", title: "On Set" },
    {
        src: "FB_IMG_1773001094387_mudaxg",
        size: "lg",
...
function GalleryCard({ img, i }: GalleryCardProps) {
    ...
    return (
        ...
        >
            ...
            <div
                className={`absolute inset-0 bg-gradient-to-t from-primary/90 via-primary/20 to-transparent transition-opacity duration-500 flex items-end p-6 pointer-events-none ${hovered ? "opacity-100" : "opacity-0"}`}
            >
                <div
                    className={`flex flex-col gap-1 transition-transform duration-500 ${hovered ? "translate-y-0" : "translate-y-4"}`}
                >
