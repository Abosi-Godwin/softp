...
export const metadata: Metadata = {
  title: {
    default: "Paulinus Onwumere Odinaka — Actor | Music Artist | 2D Animator",
  ...
  twitter: {
    ...
    images: ["/og-image.jpg"],
    creator: "@your_twitter_handle", // ← replace with real handle
  },
  ...
  // ── Verification (add keys from Google Search Console etc.) ─────────────────
  verification: {
    google: "8wKxFBoxKbThGGJsFMXBoid6P9uWONt00GcfrWKw0BU", // ← replace with real token
  }, 
};
...
const jsonLd = [
    // Person schema (already have this)
    {
    ...
    // BreadcrumbList — helps Google understand site structure
    {
        ...
        itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: "Films", item: `${BASE_URL}/films` },
            { "@type": "ListItem", position: 3, name: "Music", item: `${BASE_URL}/music` },
            { "@type": "ListItem", position: 4, name: "Animation", item: `${BASE_URL}/animation` },
        ],
    },
];
// ─── Root Layout ──────────────────────────────────────────────────────────────
